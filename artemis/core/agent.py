...
Includes strategy selection, evidence extraction, and causal reasoning.
"""
...
@dataclass
class OpponentModel:
    """Model of an opponent's debate behavior and patterns."""
    ...
    def update(self, argument: Argument) -> None:
        """Update model with a new argument from this opponent."""
...
class Agent:
    ...
    def causal_graph(self) -> CausalGraph:
        """Get the agent's causal graph built from arguments."""
        return self._causal_graph

    @property
    def current_strategy(self) -> DebateStrategy:
    ...
    def observe_opponent(self, argument: Argument) -> None:
        ...
        Args:
            argument: The opponent's argument to analyze.
        """
    ...
    def get_opponent_model(self, opponent_name: str) -> OpponentModel | None:
        """Get the model for a specific opponent."""
        return self._opponent_models.get(opponent_name)

    def extract_evidence(self, text: str) -> list[ExtractedEvidence]:
        """
        Extract evidence from text using the agent's extractor.
    ...
    def build_strategy_instructions(self, strategy: DebateStrategy) -> str:
        """
        Build additional instructions based on current strategy.
    ...
    async def generate_argument(
        ...
        Args:
            ...
            use_strategy: Whether to apply strategy-based instructions.
